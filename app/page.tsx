...
const sample: EgoNode[] = [
  ...
  { id: "7", name: "유진", level: 3 },
  { id: "8", name: "나영", level: 3 },
  { id: "9", name: "다혜", level: 3 },
  { id: "10", name: "둘리", level: 3 },
  { id: "11", name: "또치", level: 2 },
  { id: "12", name: "도우", level: 2 },
  { id: "13", name: "기현", level: 2 },
  { id: "14", name: "세아", level: 2 },
